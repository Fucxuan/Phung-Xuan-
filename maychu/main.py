...
def initializeDb():
    ...
    c.execute('CREATE TABLE IF NOT EXISTS clients (name TEXT, age TEXT , CCCD TEXT)')
...
if __name__ == "__main__":
    if check_if_opened_before():
        print("Chương trình đã mở trước đó!")
        start_login_page.startLoginPage() # bắt đầu start_login_page.py của bạn

    else:
        print("Lần đầu tiên mở chương trình!")
        initializeDb()
